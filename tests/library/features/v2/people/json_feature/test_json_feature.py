...
from library.features.people.json_feature.features_people_json_feature import FeaturesPeopleJsonFeature
...
def test_json_feature(spark_session: SparkSession) -> None:
    ...
    SparkPipelineFrameworkTestRunnerV2(logger = logger,spark_session=spark_session, test_path=test_path, test_name=test_name,
                                       ...
                                       helix_transformers=[FeaturesPeopleJsonFeature], test_inputs=[input_file],
